        ...
        <li v-for="(part, index) in jsonData" :key="index" class="c-placement">
            <div>
                <span @click="toggleNode(part)"
                    :class="{ 'caret': hasChildParts(part), 'no-caret': !hasChildParts(part), 'caret-down': part.expanded, 'exists': part.existsMet, 'not-exists': !part.existsMet, 'changed': part.changedMet}" 
                    class="c-text">
